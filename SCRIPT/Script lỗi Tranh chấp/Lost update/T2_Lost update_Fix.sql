...
-- T2_FIX: tương đương với proc ChonDonHang nhưng có thêm updlock để tránh đọc dữ liệu khi 1 trans chuẩn bị ghi
...
BEGIN TRAN
	...
	IF @MaDonHang IS NULL OR NOT EXISTS ( SELECT MADONHANG FROM DONHANG  WITH(UPDLOCK) WHERE TINHTRANGDONHANG = N'Đồng ý' )
	BEGIN
