...
GO
CREATE LOGIN [DTA08002916356] WITH PASSWORD=N'Partner', DEFAULT_DATABASE=[QLDatChuyenHangOnl], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF
GO
...
GO
CREATE USER [DTA08002916356] FOR LOGIN [DTA08002916356] WITH DEFAULT_SCHEMA=[dbo]
GO
...
GO
ALTER ROLE [PartnerROLE] ADD MEMBER [DTA08002916356]
GO
